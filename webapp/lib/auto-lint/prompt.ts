...
export function buildAutoLintPrompt(input: {
  ...
  return [
    ...
    "Read CLAUDE.md/AGENTS.md and follow .agents/skills/wiki-lint/SKILL.md. If additional skills are needed, project .agents/skills takes priority, then ~/.agents/skills, then host-specific global skill directories such as ~/.codex/skills or ~/.claude/skills.",
