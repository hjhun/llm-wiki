...
export function buildGraphifyPrompt(
  ...
  return [
    ...
    "   After all needed partials are present for build/update, `node scripts/merge-graph-parts.mjs --parts wiki/graph/parts --out wiki/graph/graph.json --report wiki/graph/GRAPH_REPORT.md` is the project-local deterministic merge helper for Code Facts partials.",
