...
export const TEXT = {
  ko: {
    ...
    settings: {
      ...
      agentNamePrefix: "콜사인 시드",
      managerName: "관리자 이름",
      agentOrchestrationDesc:
        "/ingest, /ingest-loop, /lint는 실시간 콜사인과 임무가 붙은 에이전트들을 실행하고 관리자 에이전트가 결과를 정리합니다. /query는 단일 에이전트로 실행됩니다.",
      ...
      publicQuerySandboxDesc:
        "켜면 public CLI를 격리된 HOME에서 실행합니다. 호스트의 ~/.codex, ~/.claude, ~/.cline* 등 에이전트 설정과 agent-browser 설치물은 읽기 전용으로 공유합니다.",
      password: "Password",
      admin: "admin",
  ...
  en: {
    ...
    settings: {
      ...
      agentNamePrefix: "Callsign seed",
      managerName: "Manager name",
      agentOrchestrationDesc:
        "/ingest, /ingest-loop, and /lint run agents with live callsigns and mission roles, then a manager agent consolidates the report. /query runs as a single agent.",
      runtimeDefaults: "Runtime Defaults",
      wikiOperation: "wiki operation",
      ...
      publicQuerySandboxDesc:
        "When on, public CLI runs with an isolated HOME. Host agent settings such as ~/.codex, ~/.claude, ~/.cline* and agent-browser installs are shared read-only.",
      password: "Password",
      admin: "admin",
      currentPassword: "Current password",
      newPassword: "New password",
