...
export const TEXT = {
  ko: {
    ...
    settings: {
      ...
      agentOrchestrationDesc:
        "/ingest, /ingest-loop, /query, /lint는 이 한도 안에서 이름이 붙은 워커들을 실행하고, 관리자 에이전트가 결과를 정리해 보고합니다.",
  ...
  en: {
    ...
    settings: {
      ...
      agentOrchestrationDesc:
        "/ingest, /ingest-loop, /query, and /lint run named workers within this limit, then a manager agent consolidates the report.",
      runtimeDefaults: "Runtime Defaults",
      wikiOperation: "wiki operation",
      chunkMaxFiles: "Chunk max files",
      chunkMaxBytes: "Chunk max bytes",
